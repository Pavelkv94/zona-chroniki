 ...
 * ArtifactSpawn НЕ регистрируется в registerPhase1Systems и не создаётся worldgen'ом
 * (носителей AnomalyField текущий worldgen не заводит — до 2.16). На текущем мире
 * система — no-op (полей нет ⇒ ранний выход), поэтому голдены пустого мира и
 * sim:100days НЕ сдвигаются. Подключение к worldgen/pipeline — задача 2.16.
 */

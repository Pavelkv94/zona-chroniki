 ...
 * Radio включена в единый конвейер Фазы 3 (registerPhase3Systems: … MemoryDecay → Radio →
 * Rumors → Chronicle → Death) вместе с Chronicle 3.2 / Rumors 3.6. Голдены ЗАКОННО сдвинулись
 * (эфир заполняет лог radio/message): sim:100days fd0bec10 → 561cc138, day1 seed42 3c54d141 →
 * f554331d. Пустой мир 481914ae цел (нет наблюдателей ⇒ no-op). EconomyInvariant не затронут
 * (radio/message массу/деньги не творит, закон №3). ПЕРФ-ФЛАГ D-074 (эфир+молва на плотном
 * старте) — балансовый, для balance-analyst; логику Radio 3.7 НЕ трогала (закон №6).
 *
 * ```mermaid
 * flowchart TD

 ...
 * (позиции/смерти/восприятие/масса) тождественна Фазе 2 (perception/spotted = 7268 после 5.2, MUST-9).
 */
...
describe('MUST · Гейт Perception по актёрам: не-акторы (поселения+поля) вне spotted (P-2, D-072)', () => {
  ...
  it('счётчик perception/spotted за день-1 seed42 ЗАФИКСИРОВАН числом: 7268 (шум не-акторов убран, D-072)', () => {
    ...
    // ⇒ иной детерминированный набор встреч дня-1: perception/spotted 9217 → 7268. НЕ регресс:
    ...
    expect(spotted).toHaveLength(7268);
